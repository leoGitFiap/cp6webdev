function Sobre() {
  return (
    <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8 text-center">
      <h2 className="text-4xl text-green-500 font-extrabold text-primary mb-8">Sobre Nós</h2>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <a href="https://github.com/leoGitFiap" className="text-sm text-blue-400 max-w-2xl mx-auto">Leonardo Fernandes Mesquita, RM:559623</a>
    </div>
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <a href="https://github.com/MACF77" className="text-sm text-blue-400 max-w-2xl mx-auto">Marco Antonio Caires Freire, RM:559256</a>
    </div>
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <a href="https://github.com/Guiitens2005" className="text-sm text-blue-400 max-w-2xl mx-auto">Guilherme Augusto Caseiro, RM:559765</a>
    </div>
    </div>
  );
}
